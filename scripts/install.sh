...
export INSTALL_VERSION=${INSTALL_VERSION:-"v0.0.1-alpha.17"}
...
export DOWNLOAD_LINK="https://github.com/zcloud-ws/secure-templates/releases/download/${INSTALL_VERSION}/${FILE_NAME}"
